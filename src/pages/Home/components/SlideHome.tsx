...
export default function SlideHome({
  ...
  slidesPerGroup,
  listItem,
  buttonStylePrev = 'rounded-full flex item-center justify-center bg-white bg-opacity-60 transition-all duration-400 w-12 h-12 translate-x-[-100%] group-hover:translate-x-[10px]',
  buttonStyleNext = 'rounded-full flex item-center justify-center bg-white bg-opacity-60 transition-all duration-400 w-12 h-12 translate-x-[100%] group-hover:translate-x-[-10px]',
  slidesPerView,
  spaceBetween,
  pagination,
  autoplay,
